...
FIELDS = {
    ...
    "BLG_3": (
        "sequence",
        DATATYPES_STRUCTS["CK_ACCOUNT_NO"],
        "CK_ACCOUNT_NO",
        "ACCOUNT_ID",
        None,
        -1,
    ...
    "BTS_3": (
        "sequence",
        DATATYPES_STRUCTS["CM_BATCH_TOTAL"],
        "CM_BATCH_TOTAL",
        "BATCH_TOTALS",
        None,
        -1,
    ...
    "FT1_16": (
        "sequence",
        DATATYPES_STRUCTS["CM_INTERNAL_LOCATION"],
    ...
    "OBR_26": (
        "sequence",
        DATATYPES_STRUCTS["CM_PARENT_RESULT"],
        "CM_PARENT_RESULT",
        "PARENT_RESULT",
        None,
        -1,
    ...
    "PID_20": (
        "sequence",
        DATATYPES_STRUCTS["CM_LICENSE_NO"],
        "CM_LICENSE_NO",
    ...
    "PR1_12": (
        "sequence",
        DATATYPES_STRUCTS["CM_PRACTITIONER"],
        "CM_PRACTITIONER",
    ...
    "PV1_50": (
        "sequence",
        DATATYPES_STRUCTS["CM_PAT_ID_0192"],
        "CM_PAT_ID_0192",
        "ALTERNATE_VISIT_ID",
        None,
        -1,
