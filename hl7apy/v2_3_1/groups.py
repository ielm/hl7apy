...
GROUPS = {
    ...
    "PPR_PC1_PROBLEM": (
        ...
        (
            ...
            ["PPR_PC1_PATHWAY_OBSERVATION", None, (0, -1), "GRP"],
    ...
    "RDE_O01_ORDER": (
        ...
        (
            ...
            ["RXR", SEGMENTS["RXR"], (1, -1), "SEG"],
            ["RXC", SEGMENTS["RXC"], (0, -1), "SEG"],
            ["RDE_O01_OBSERVATION", None, (0, -1), "GRP"],
            ["CTI", SEGMENTS["CTI"], (0, -1), "SEG"],
        ),
    ),
    ...
    "RDS_O01_ORDER": (
        ...
        (
            ...
            ["RXR", SEGMENTS["RXR"], (1, -1), "SEG"],
            ["RXC", SEGMENTS["RXC"], (0, -1), "SEG"],
            ["RDS_O01_OBSERVATION", None, (0, -1), "GRP"],
        ),
    ),
    ...
    "RGV_O01_GIVE": (
        ...
        (
            ...
            ["RXR", SEGMENTS["RXR"], (1, -1), "SEG"],
            ["RXC", SEGMENTS["RXC"], (0, -1), "SEG"],
            ["RGV_O01_OBSERVATION", None, (1, -1), "GRP"],
        ),
    ),
    "RGV_O01_OBSERVATION": (
        "sequence",
    ...
    "RRE_O02_RESPONSE": (
        "sequence",
        (
            ["RRE_O02_PATIENT", None, (0, 1), "GRP"],
            ["RRE_O02_ORDER", None, (1, -1), "GRP"],
        ),
    ),
    "RRG_O02_GIVE": (
        "sequence",
