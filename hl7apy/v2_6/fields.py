...
FIELDS = {
    ...
    "ADJ_4": ("leaf", None, "IS", "ADJUSTMENT_CATEGORY", "HL70564", -1),
    "ADJ_5": ("sequence", DATATYPES_STRUCTS["CP"], "CP", "ADJUSTMENT_AMOUNT", None, -1),
    "ADJ_6": (
        "sequence",
        DATATYPES_STRUCTS["CQ"],
        "CQ",
        "ADJUSTMENT_QUANTITY",
        "HL70560",
        -1,
    ...
    "ADJ_11": ("leaf", None, "IS", "ADJUSTMENT_ACTION", "HL70569", -1),
    "ADJ_12": (
        "sequence",
        DATATYPES_STRUCTS["EI"],
        "EI",
    ...
    "CON_25": ("leaf", None, "IS", "RELATIONSHIP_TO_SUBJECT", "HL70548", -1),
    "CSP_1": (
        "sequence",
        DATATYPES_STRUCTS["CWE"],
        "CWE",
    ...
    "DG1_25": ("leaf", None, "IS", "DRG_DIAGNOSIS_DETERMINATION_STATUS", "HL70731", -1),
    "DG1_26": ("leaf", None, "IS", "PRESENT_ON_ADMISSION_POA_INDICATOR", "HL70895", -1),
    "DMI_1": (
        "sequence",
        DATATYPES_STRUCTS["CNE"],
        "CNE",
    ...
    "DRG_17": ("leaf", None, "IS", "STATUS_PATIENT", "HL70739", -1),
    "DRG_18": ("leaf", None, "ST", "GROUPER_SOFTWARE_NAME", None, -1),
    "DRG_19": ("leaf", None, "ST", "GROUPER_SOFTWARE_VERSION", None, -1),
    "DRG_20": ("leaf", None, "IS", "STATUS_FINANCIAL_CALCULATION", "HL70742", -1),
    "DRG_21": (
        "sequence",
        DATATYPES_STRUCTS["MO"],
        "MO",
    ...
    "DRG_26": ("leaf", None, "IS", "STATUS_GENDER", "HL70749", -1),
    "DRG_27": ("leaf", None, "IS", "STATUS_AGE", "HL70749", -1),
    "DRG_28": ("leaf", None, "IS", "STATUS_LENGTH_OF_STAY", "HL70749", -1),
    "DRG_29": ("leaf", None, "IS", "STATUS_SAME_DAY_FLAG", "HL70749", -1),
    "DRG_30": ("leaf", None, "IS", "STATUS_SEPARATION_MODE", "HL70749", -1),
    "DRG_31": ("leaf", None, "IS", "STATUS_WEIGHT_AT_BIRTH", "HL70755", -1),
    "DRG_32": ("leaf", None, "IS", "STATUS_RESPIRATION_MINUTES", "HL70757", -1),
    "DRG_33": ("leaf", None, "IS", "STATUS_ADMISSION", "HL70759", -1),
    ...
    "ITM_19": ("leaf", None, "IS", "ITEM_NATURAL_ACCOUNT_CODE", "HL70320", -1),
    ...
    "IVC_4": ("leaf", None, "IS", "INVOICE_CONTROL", "HL70553", -1),
    "IVC_5": ("leaf", None, "IS", "INVOICE_REASON", "HL70554", -1),
    "IVC_6": ("leaf", None, "IS", "INVOICE_TYPE", "HL70555", -1),
    ...
    "IVC_25": ("leaf", None, "IS", "BENEFIT_GROUP", "HL70556", -1),
    "IVC_26": ("leaf", None, "ST", "PROVIDER_TAX_ID", None, -1),
    "IVC_27": ("leaf", None, "ST", "PAYER_TAX_ID", None, -1),
    "IVC_28": ("leaf", None, "IS", "PROVIDER_TAX_STATUS", "HL70572", -1),
    "IVC_29": ("leaf", None, "IS", "PAYER_TAX_STATUS", "HL70572", -1),
    ...
    "IVT_8": ("sequence", DATATYPES_STRUCTS["CWE"], "CWE", "ORDER_PACKAGING", None, -1),
    ...
    "OBR_6": ("leaf", None, "DTM", "REQUESTED_DATE_TIME", None, -1),
    ...
    "OBR_14": ("leaf", None, "DTM", "SPECIMEN_RECEIVED_DATE_TIME", None, -1),
    "OBR_15": (
        "sequence",
        DATATYPES_STRUCTS["SPS"],
        "SPS",
        "SPECIMEN_SOURCE",
        None,
        -1,
    ...
    "OM7_10": ("leaf", None, "IS", "TEST_SERVICE_DEFAULT_FREQUENCY", None, -1),
    ...
    "PCE_2": ("leaf", None, "IS", "COST_CENTER_ACCOUNT_NUMBER", "HL70319", -1),
    "PCE_3": (
        "sequence",
        DATATYPES_STRUCTS["CWE"],
        "CWE",
    ...
    "PR1_21": ("leaf", None, "IS", "DRG_PROCEDURE_DETERMINATION_STATUS", "HL70761", -1),
    "PR1_22": ("leaf", None, "IS", "DRG_PROCEDURE_RELEVANCE", "HL70763", -1),
    "PRA_1": (
        "sequence",
        DATATYPES_STRUCTS["CWE"],
        "CWE",
    ...
    "PSL_20": ("leaf", None, "IS", "PROCESSING_CONSIDERATION_CODE", "HL70562", -1),
    ...
    "PYE_2": ("leaf", None, "IS", "PAYEE_TYPE", "HL70557", -1),
    "PYE_3": (
        "leaf",
        None,
        "IS",
    ...
    "PYE_7": ("leaf", None, "IS", "PAYMENT_METHOD", "HL70570", -1),
    ...
    "QRD_1": ("leaf", None, "DTM", "QUERY_DATE_TIME", None, -1),
    ...
    "QRD_6": ("leaf", None, "DTM", "DEFERRED_RESPONSE_DATE_TIME", None, -1),
    "QRD_7": (
        "sequence",
        DATATYPES_STRUCTS["CQ"],
        "CQ",
    ...
    "QRF_2": ("leaf", None, "DTM", "WHEN_DATA_START_DATE_TIME", None, -1),
    "QRF_3": ("leaf", None, "DTM", "WHEN_DATA_END_DATE_TIME", None, -1),
    ...
    "RQD_7": ("leaf", None, "IS", "COST_CENTER_ACCOUNT_NUMBER", "HL70319", -1),
    ...
    "SDD_4": ("leaf", None, "IS", "DEVICE_DATA_STATE", "HL70667", -1),
    "SDD_5": ("leaf", None, "IS", "LOAD_STATUS", "HL70669", -1),
    ...
    "UB1_2": ("leaf", None, "SI", "BLOOD_DEDUCTIBLE", None, -1),
    "UB1_3": ("leaf", None, "NM", "BLOOD_FURNISHED_PINTS", None, -1),
    "UB1_4": ("leaf", None, "NM", "BLOOD_REPLACED_PINTS", None, -1),
    "UB1_5": ("leaf", None, "NM", "BLOOD_NOT_REPLACED_PINTS", None, -1),
    "UB1_6": ("leaf", None, "NM", "CO_INSURANCE_DAYS", None, -1),
    "UB1_7": ("leaf", None, "IS", "CONDITION_CODE", "HL70043", -1),
    "UB1_8": ("leaf", None, "NM", "COVERED_DAYS", None, -1),
    "UB1_9": ("leaf", None, "NM", "NON_COVERED_DAYS", None, -1),
    "UB1_10": (
        "sequence",
        DATATYPES_STRUCTS["UVC"],
        "UVC",
        "VALUE_AMOUNT_CODE",
        None,
        -1,
    ),
    "UB1_11": ("leaf", None, "NM", "NUMBER_OF_GRACE_DAYS", None, -1),
    "UB1_12": (
        "sequence",
        DATATYPES_STRUCTS["CWE"],
        "CWE",
    ...
    "UB1_14": ("leaf", None, "DT", "PSRO_UR_APPROVED_STAY_FM", None, -1),
    "UB1_15": ("leaf", None, "DT", "PSRO_UR_APPROVED_STAY_TO", None, -1),
    "UB1_16": ("sequence", DATATYPES_STRUCTS["OCD"], "OCD", "OCCURRENCE", None, -1),
    "UB1_17": (
        "sequence",
        DATATYPES_STRUCTS["CWE"],
        "CWE",
    ...
    "UB1_18": ("leaf", None, "DT", "OCCUR_SPAN_START_DATE", None, -1),
    "UB1_19": ("leaf", None, "DT", "OCCUR_SPAN_END_DATE", None, -1),
    ...
    "URD_1": ("leaf", None, "DTM", "R_U_DATE_TIME", None, -1),
    ...
    "URS_2": ("leaf", None, "DTM", "R_U_WHEN_DATA_START_DATE_TIME", None, -1),
    "URS_3": ("leaf", None, "DTM", "R_U_WHEN_DATA_END_DATE_TIME", None, -1),
