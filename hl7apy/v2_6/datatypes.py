...
DATATYPES = {
    ...
    "ELD_4": ["sequence", None, "CWE", "CODE_IDENTIFYING_ERROR", None, -1],
    ...
    "FC_1": ["leaf", None, "IS", "FINANCIAL_CLASS_CODE", None, -1],
    ...
    "ICD_1": ["leaf", None, "IS", "CERTIFICATION_PATIENT_TYPE", None, -1],
    ...
    "LA1_1": ["leaf", None, "IS", "POINT_OF_CARE", None, -1],
    ...
    "LA2_6": ["leaf", None, "IS", "PATIENT_LOCATION_TYPE", None, -1],
    ...
    "PLN_2": ["leaf", None, "IS", "TYPE_OF_ID_NUMBER", None, -1],
    ...
    "PPN_18": ["sequence", None, "DR", "NAME_VALIDITY_RANGE", None, -1],
    ...
    "SPS_2": ["sequence", None, "CWE", "ADDITIVES", None, -1],
    "SPS_3": ["leaf", None, "TX", "SPECIMEN_COLLECTION_METHOD", None, -1],
    "SPS_4": ["sequence", None, "CWE", "BODY_SITE", None, -1],
    "SPS_5": ["sequence", None, "CWE", "SITE_MODIFIER", None, -1],
    ...
    "TQ_5": ["leaf", None, "DTM", "END_DATE_TIME", None, -1],
    ...
    "TQ_11": ["sequence", None, "CWE", "OCCURRENCE_DURATION", None, -1],
    "TQ_12": ["leaf", None, "NM", "TOTAL_OCCURRENCES", None, -1],
    "UVC_1": ["sequence", None, "CNE", "VALUE_CODE", None, -1],
    ...
    "XAD_12": ["sequence", None, "DR", "ADDRESS_VALIDITY_RANGE", None, -1],
    ...
    "XCN_17": ["sequence", None, "DR", "NAME_VALIDITY_RANGE", None, -1],
    ...
    "XON_4": ["leaf", None, "NM", "IDENTIFIER_CHECK_DIGIT", None, -1],
    "XON_5": ["leaf", None, "ID", "CHECK_DIGIT_SCHEME", None, -1],
    ...
    "XPN_10": ["sequence", None, "DR", "NAME_VALIDITY_RANGE", None, -1],
...
DATATYPES_STRUCTS = {
    ...
    "OSD": (
        ("OSD_1", DATATYPES["OSD_1"], (1, 1), "CMP"),
        ("OSD_2", DATATYPES["OSD_2"], (1, 1), "CMP"),
        ("OSD_3", DATATYPES["OSD_3"], (0, 1), "CMP"),
        ("OSD_4", DATATYPES["OSD_4"], (1, 1), "CMP"),
        ("OSD_5", DATATYPES["OSD_5"], (0, 1), "CMP"),
        ("OSD_6", DATATYPES["OSD_6"], (0, 1), "CMP"),
        ("OSD_7", DATATYPES["OSD_7"], (0, 1), "CMP"),
        ("OSD_8", DATATYPES["OSD_8"], (1, 1), "CMP"),
        ("OSD_9", DATATYPES["OSD_9"], (0, 1), "CMP"),
        ("OSD_10", DATATYPES["OSD_10"], (1, 1), "CMP"),
