TABLES = {
    ...
    "HL70005": (
        "Race",
        ("...", "1002-5", "2028-9", "2054-5", "2076-8", "2106-3", "2131-1"),
    ),
    "HL70006": (
        "Religion",
        (
    ...
    "HL70062": ("Event reason", ("01", "02", "03", "O", "U")),
    "HL70063": (
        "Relationship",
        (
            "ASC",
    ...
    "HL70093": ("Release Information", ("_", "N", "Y")),
    ...
    "HL70156": (
        ...
        ("ANY", "COL", "ORD", "RCT", "REP", "SCHED"),
    ),
    "HL70157": (
        "Which date/time status qualifier",
        ("ANY", "CFN", "COR", "FIN", "PRE", "REP"),
    ),
    ...
    "HL70190": (
        "Address type",
        ("B", "BA", "BDL", "BR", "C", "F", "H", "L", "M", "N", "O", "P", "RH"),
    ),
    "HL70191": (
    ...
    "HL70201": (
        ...
        ("ASN", "BPN", "EMR", "NET", "ORN", "PRN", "VHN", "WPN"),
    ),
    "HL70202": (
        "Telecommunication equipment type",
        ("BP", "CP", "FX", "Internet", "MD", "PH", "TDD", "TTY", "X.400"),
    ),
    "HL70203": (
        "Identifier type",
        (
    ...
    "HL70243": ("IdentityMay Be Divulged", ("N", "NA", "Y")),
    "HL70247": (
        "Status of Evaluation",
        ("A", "C", "D", "I", "K", "O", "P", "Q", "R", "U", "X", "Y"),
    ),
    "HL70248": ("Product source", ("A", "L", "N", "R")),
    "HL7025": ("Relatedness Assessment", ("H", "I", "M", "N", "S")),
    "HL70251": (
    ...
    "HL70322": ("Completion Status for valid values.", ("CP", "NA", "PA", "RE")),
    "HL70323": ("Action Code", ("A", "D", "U", "X")),
    "HL70324": (
    ...
    "HL70359": ("Diagnosis Priority", ("0", "1", "2 _")),
    "HL70360": (
    ...
    "HL70391": (
        "Segment group",
        ("OBRG", "ORCG", "PIDG", "RXAG", "RXDG", "RXEG", "RXOG"),
    ),
    ...
    "HL70418": ("Procedure Priority", ("0", "1", "2 _")),
    ...
    "HL70475": ("Charge Type Reason", ("01", "02", "03", "04", "05")),
    ...
    "HL70524": ("Sequence condition", ("C", "R", "S")),
    ...
    "HL70548": (
        "Signatory_s Relationship to Subject",
        ("1", "2", "3", "4", "5", "6", "7"),
    ),
    "HL70550": (
        "Body Parts",
