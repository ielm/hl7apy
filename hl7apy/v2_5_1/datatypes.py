...
DATATYPES = {
    ...
    "AD_6": ["leaf", None, "ID", "COUNTRY", "HL70399", -1],
    "AD_7": ["leaf", None, "ID", "ADDRESS_TYPE", "HL70190", -1],
    ...
    "CCD_1": ["leaf", None, "ID", "INVOCATION_EVENT", "HL70100", -1],
    ...
    "CE_3": ["leaf", None, "ID", "NAME_OF_CODING_SYSTEM", "HL70396", -1],
    ...
    "CF_6": ["leaf", None, "ID", "NAME_OF_ALTERNATE_CODING_SYSTEM", "HL70396", -1],
    ...
    "CNN_7": ["leaf", None, "IS", "DEGREE_E_G_MD", "HL70360", -1],
    "CNN_8": ["leaf", None, "IS", "SOURCE_TABLE", "HL70297", -1],
    "CNN_9": ["leaf", None, "IS", "ASSIGNING_AUTHORITY_NAMESPACE_ID", "HL70363", -1],
    ...
    "CSU_4": ["leaf", None, "ID", "UNIT_OF_MEASURE_CODING_SYSTEM", "HL70396", -1],
    ...
    "CX_3": ["leaf", None, "ID", "CHECK_DIGIT_SCHEME", "HL70061", -1],
    "CX_4": ["sequence", None, "HD", "ASSIGNING_AUTHORITY", "HL70363", -1],
    "CX_5": ["leaf", None, "ID", "IDENTIFIER_TYPE_CODE", "HL70203", -1],
    ...
    "DIN_2": ["sequence", None, "CE", "INSTITUTION_NAME", "HL70531", -1],
    "DLD_1": ["leaf", None, "IS", "DISCHARGE_LOCATION", "HL70113", -1],
    "DLD_2": ["sequence", None, "TS", "EFFECTIVE_DATE", None, -1],
    "DLN_1": ["leaf", None, "ST", "LICENSE_NUMBER", None, -1],
    "DLN_2": ["leaf", None, "IS", "ISSUING_STATE_PROVINCE_COUNTRY", "HL70333", -1],
    ...
    "DLT_3": ["leaf", None, "ID", "CHANGE_COMPUTATION", "HL70523", -1],
    ...
    "DTN_1": ["leaf", None, "IS", "DAY_TYPE", "HL70149", -1],
    ...
    "ELD_2": ["leaf", None, "NM", "SEGMENT_SEQUENCE", None, -1],
    "ELD_3": ["leaf", None, "NM", "FIELD_POSITION", None, -1],
    "ELD_4": ["sequence", None, "CE", "CODE_IDENTIFYING_ERROR", "HL70357", -1],
    ...
    "FC_1": ["leaf", None, "IS", "FINANCIAL_CLASS_CODE", "HL70064", -1],
    ...
    "ICD_1": ["leaf", None, "IS", "CERTIFICATION_PATIENT_TYPE", "HL70150", -1],
    "ICD_2": ["leaf", None, "ID", "CERTIFICATION_REQUIRED", "HL70136", -1],
    "ICD_3": ["sequence", None, "TS", "DATE_TIME_CERTIFICATION_REQUIRED", None, -1],
    ...
    "LA1_1": ["leaf", None, "IS", "POINT_OF_CARE", "HL70302", -1],
    "LA1_2": ["leaf", None, "IS", "ROOM", "HL70303", -1],
    "LA1_3": ["leaf", None, "IS", "BED", "HL70304", -1],
    "LA1_4": ["sequence", None, "HD", "FACILITY", None, -1],
    "LA1_5": ["leaf", None, "IS", "LOCATION_STATUS", "HL70306", -1],
    "LA1_6": ["leaf", None, "IS", "PATIENT_LOCATION_TYPE", "HL70305", -1],
    "LA1_7": ["leaf", None, "IS", "BUILDING", "HL70307", -1],
    "LA1_8": ["leaf", None, "IS", "FLOOR", "HL70308", -1],
    "LA1_9": ["sequence", None, "AD", "ADDRESS", None, -1],
    "LA2_1": ["leaf", None, "IS", "POINT_OF_CARE", "HL70302", -1],
    "LA2_2": ["leaf", None, "IS", "ROOM", "HL70303", -1],
    "LA2_3": ["leaf", None, "IS", "BED", "HL70304", -1],
    "LA2_4": ["sequence", None, "HD", "FACILITY", None, -1],
    "LA2_5": ["leaf", None, "IS", "LOCATION_STATUS", "HL70306", -1],
    "LA2_6": ["leaf", None, "IS", "PATIENT_LOCATION_TYPE", "HL70305", -1],
    "LA2_7": ["leaf", None, "IS", "BUILDING", "HL70307", -1],
    "LA2_8": ["leaf", None, "IS", "FLOOR", "HL70308", -1],
    ...
    "LA2_14": ["leaf", None, "ID", "COUNTRY", "HL70399", -1],
    "LA2_15": ["leaf", None, "ID", "ADDRESS_TYPE", "HL70190", -1],
    ...
    "MA_3": ["leaf", None, "NM", "SAMPLE_1_FROM_CHANNEL_N", None, -1],
    "MA_4": ["leaf", None, "NM", "SAMPLE_2_FROM_CHANNEL_1", None, -1],
    "MA_5": ["leaf", None, "NM", "SAMPLE_2_FROM_CHANNEL_N", None, -1],
    "MA_6": ["leaf", None, "NM", "SAMPLE_N_FROM_CHANNEL_N", None, -1],
    ...
    "MOP_1": ["leaf", None, "ID", "MONEY_OR_PERCENTAGE_INDICATOR", "HL70148", -1],
    "MOP_2": ["leaf", None, "NM", "MONEY_OR_PERCENTAGE_QUANTITY", None, -1],
    "MOP_3": ["leaf", None, "ID", "CURRENCY_DENOMINATION", None, -1],
    "MSG_1": ["leaf", None, "ID", "MESSAGE_CODE", "HL70076", -1],
    "MSG_2": ["leaf", None, "ID", "TRIGGER_EVENT", "HL70003", -1],
    "MSG_3": ["leaf", None, "ID", "MESSAGE_STRUCTURE", "HL70354", -1],
    ...
    "NDL_4": ["leaf", None, "IS", "POINT_OF_CARE", "HL70302", -1],
    "NDL_5": ["leaf", None, "IS", "ROOM", "HL70303", -1],
    "NDL_6": ["leaf", None, "IS", "BED", "HL70304", -1],
    "NDL_7": ["sequence", None, "HD", "FACILITY", None, -1],
    "NDL_8": ["leaf", None, "IS", "LOCATION_STATUS", "HL70306", -1],
    "NDL_9": ["leaf", None, "IS", "PATIENT_LOCATION_TYPE", "HL70305", -1],
    "NDL_10": ["leaf", None, "IS", "BUILDING", "HL70307", -1],
    "NDL_11": ["leaf", None, "IS", "FLOOR", "HL70308", -1],
    "NR_1": ["leaf", None, "NM", "LOW_VALUE", None, -1],
    "NR_2": ["leaf", None, "NM", "HIGH_VALUE", None, -1],
    "OCD_1": ["sequence", None, "CNE", "OCCURRENCE_CODE", "HL70350", -1],
    "OCD_2": ["leaf", None, "DT", "OCCURRENCE_DATE", None, -1],
    "OSD_1": ["leaf", None, "ID", "SEQUENCE_RESULTS_FLAG", "HL70524", -1],
    "OSD_2": ["leaf", None, "ST", "PLACER_ORDER_NUMBER_ENTITY_IDENTIFIER", None, -1],
    "OSD_3": ["leaf", None, "IS", "PLACER_ORDER_NUMBER_NAMESPACE_ID", "HL70363", -1],
    "OSD_4": ["leaf", None, "ST", "FILLER_ORDER_NUMBER_ENTITY_IDENTIFIER", None, -1],
    "OSD_5": ["leaf", None, "IS", "FILLER_ORDER_NUMBER_NAMESPACE_ID", "HL70363", -1],
    ...
    "OSP_1": ["sequence", None, "CNE", "OCCURRENCE_SPAN_CODE", "HL70351", -1],
    "OSP_2": ["leaf", None, "DT", "OCCURRENCE_SPAN_START_DATE", None, -1],
    "OSP_3": ["leaf", None, "DT", "OCCURRENCE_SPAN_STOP_DATE", None, -1],
    "PIP_1": ["sequence", None, "CE", "PRIVILEGE", "HL70525", -1],
    "PIP_2": ["sequence", None, "CE", "PRIVILEGE_CLASS", "HL70526", -1],
    "PIP_3": ["leaf", None, "DT", "EXPIRATION_DATE", None, -1],
    "PIP_4": ["leaf", None, "DT", "ACTIVATION_DATE", None, -1],
    "PIP_5": ["sequence", None, "EI", "FACILITY", None, -1],
    "PL_1": ["leaf", None, "IS", "POINT_OF_CARE", "HL70302", -1],
    "PL_2": ["leaf", None, "IS", "ROOM", "HL70303", -1],
    "PL_3": ["leaf", None, "IS", "BED", "HL70304", -1],
    "PL_4": ["sequence", None, "HD", "FACILITY", None, -1],
    "PL_5": ["leaf", None, "IS", "LOCATION_STATUS", "HL70306", -1],
    "PL_6": ["leaf", None, "IS", "PERSON_LOCATION_TYPE", "HL70305", -1],
    "PL_7": ["leaf", None, "IS", "BUILDING", "HL70307", -1],
    "PL_8": ["leaf", None, "IS", "FLOOR", "HL70308", -1],
    ...
    "PLN_2": ["leaf", None, "IS", "TYPE_OF_ID_NUMBER", "HL70338", -1],
    ...
    "PPN_7": ["leaf", None, "IS", "DEGREE_E_G_MD", "HL70360", -1],
    "PPN_8": ["leaf", None, "IS", "SOURCE_TABLE", "HL70297", -1],
    "PPN_9": ["sequence", None, "HD", "ASSIGNING_AUTHORITY", "HL70363", -1],
    "PPN_10": ["leaf", None, "ID", "NAME_TYPE_CODE", "HL70200", -1],
    "PPN_11": ["leaf", None, "ST", "IDENTIFIER_CHECK_DIGIT", None, -1],
    "PPN_12": ["leaf", None, "ID", "CHECK_DIGIT_SCHEME", "HL70061", -1],
    "PPN_13": ["leaf", None, "ID", "IDENTIFIER_TYPE_CODE", "HL70203", -1],
    "PPN_14": ["sequence", None, "HD", "ASSIGNING_FACILITY", None, -1],
    "PPN_15": ["sequence", None, "TS", "DATE_TIME_ACTION_PERFORMED", None, -1],
    "PPN_16": ["leaf", None, "ID", "NAME_REPRESENTATION_CODE", "HL70465", -1],
    "PPN_17": ["sequence", None, "CE", "NAME_CONTEXT", "HL70448", -1],
    "PPN_18": ["sequence", None, "DR_SIMPLE", "NAME_VALIDITY_RANGE", None, -1],
    "PPN_19": ["leaf", None, "ID", "NAME_ASSEMBLY_ORDER", "HL70444", -1],
    "PPN_20": ["sequence", None, "TS", "EFFECTIVE_DATE", None, -1],
    "PPN_21": ["sequence", None, "TS", "EXPIRATION_DATE", None, -1],
    ...
    "PRL_1": ["sequence", None, "CE", "PARENT_OBSERVATION_IDENTIFIER", None, -1],
    "PRL_2": ["leaf", None, "ST", "PARENT_OBSERVATION_SUB_IDENTIFIER", None, -1],
    "PRL_3": ["leaf", None, "TX", "PARENT_OBSERVATION_VALUE_DESCRIPTOR", None, -1],
    "PT_1": ["leaf", None, "ID", "PROCESSING_ID", "HL70103", -1],
    "PT_2": ["leaf", None, "ID", "PROCESSING_MODE", "HL70207", -1],
    "PTA_1": ["leaf", None, "IS", "POLICY_TYPE", "HL70147", -1],
    "PTA_2": ["leaf", None, "IS", "AMOUNT_CLASS", "HL70193", -1],
    "PTA_3": ["leaf", None, "NM", "MONEY_OR_PERCENTAGE_QUANTITY", None, -1],
    ...
    "QSC_2": ["leaf", None, "ID", "RELATIONAL_OPERATOR", "HL70209", -1],
    "QSC_3": ["leaf", None, "ST", "VALUE", None, -1],
    "QSC_4": ["leaf", None, "ID", "RELATIONAL_CONJUNCTION", "HL70210", -1],
    "RCD_1": ["leaf", None, "ST", "SEGMENT_FIELD_NAME", None, -1],
    "RCD_2": ["leaf", None, "ID", "HL7_DATA_TYPE", "HL70440", -1],
    "RCD_3": ["leaf", None, "NM", "MAXIMUM_COLUMN_WIDTH", None, -1],
    "RFR_1": ["sequence", None, "NR", "NUMERIC_RANGE", None, -1],
    "RFR_2": ["leaf", None, "IS", "ADMINISTRATIVE_SEX", "HL70001", -1],
    ...
    "RP_3": ["leaf", None, "ID", "TYPE_OF_DATA", "HL70191", -1],
    "RP_4": ["leaf", None, "ID", "SUBTYPE", "HL70291", -1],
    "RPT_1": ["sequence", None, "CWE", "REPEAT_PATTERN_CODE", "HL70335", -1],
    "RPT_2": ["leaf", None, "ID", "CALENDAR_ALIGNMENT", "HL70527", -1],
    ...
    "RPT_6": ["leaf", None, "IS", "PERIOD_UNITS", None, -1],
    "RPT_7": ["leaf", None, "ID", "INSTITUTION_SPECIFIED_TIME", "HL70136", -1],
    "RPT_8": ["leaf", None, "ID", "EVENT", "HL70528", -1],
    "RPT_9": ["leaf", None, "NM", "EVENT_OFFSET_QUANTITY", None, -1],
    "RPT_10": ["leaf", None, "IS", "EVENT_OFFSET_UNITS", None, -1],
    ...
    "SPD_3": ["leaf", None, "ID", "ELIGIBLE_OR_CERTIFIED", "HL70337", -1],
    "SPD_4": ["leaf", None, "DT", "DATE_OF_CERTIFICATION", None, -1],
    "SPS_1": ["sequence", None, "CWE", "SPECIMEN_SOURCE_NAME_OR_CODE", None, -1],
    "SPS_2": ["sequence", None, "CWE", "ADDITIVES", "HL70371", -1],
    "SPS_3": ["leaf", None, "TX", "SPECIMEN_COLLECTION_METHOD", None, -1],
    "SPS_4": ["sequence", None, "CWE", "BODY_SITE", "HL70163", -1],
    "SPS_5": ["sequence", None, "CWE", "SITE_MODIFIER", "HL70495", -1],
    "SPS_6": ["sequence", None, "CWE", "COLLECTION_METHOD_MODIFIER_CODE", None, -1],
    "SPS_7": ["sequence", None, "CWE", "SPECIMEN_ROLE", "HL70369", -1],
    "SRT_1": ["leaf", None, "ST", "SORT_BY_FIELD", None, -1],
    "SRT_2": ["leaf", None, "ID", "SEQUENCING", "HL70397", -1],
    ...
    "TQ_8": ["leaf", None, "TX", "TEXT", None, -1],
    "TQ_9": ["leaf", None, "ID", "CONJUNCTION", "HL70472", -1],
    "TQ_10": ["sequence", None, "OSD", "ORDER_SEQUENCING", None, -1],
    "TQ_11": ["sequence", None, "CE", "OCCURRENCE_DURATION", None, -1],
    "TQ_12": ["leaf", None, "NM", "TOTAL_OCCURRENCES", None, -1],
    "TS_1": ["leaf", None, "DTM", "TIME", None, -1],
    "TS_2": ["leaf", None, "ID", "DEGREE_OF_PRECISION", "HL70529", -1],
    "UVC_1": ["sequence", None, "CNE", "VALUE_CODE", "HL70153", -1],
    "UVC_2": ["sequence", None, "MO", "VALUE_AMOUNT", None, -1],
    "VH_1": ["leaf", None, "ID", "START_DAY_RANGE", "HL70267", -1],
    "VH_2": ["leaf", None, "ID", "END_DAY_RANGE", "HL70267", -1],
    "VH_3": ["leaf", None, "TM", "START_HOUR_RANGE", None, -1],
    "VH_4": ["leaf", None, "TM", "END_HOUR_RANGE", None, -1],
    "VID_1": ["leaf", None, "ID", "VERSION_ID", "HL70104", -1],
    "VID_2": ["sequence", None, "CE", "INTERNATIONALIZATION_CODE", "HL70399", -1],
    ...
    "XAD_6": ["leaf", None, "ID", "COUNTRY", "HL70399", -1],
    "XAD_7": ["leaf", None, "ID", "ADDRESS_TYPE", "HL70190", -1],
    "XAD_8": ["leaf", None, "ST", "OTHER_GEOGRAPHIC_DESIGNATION", None, -1],
    "XAD_9": ["leaf", None, "IS", "COUNTY_PARISH_CODE", "HL70289", -1],
    "XAD_10": ["leaf", None, "IS", "CENSUS_TRACT", "HL70288", -1],
    "XAD_11": ["leaf", None, "ID", "ADDRESS_REPRESENTATION_CODE", "HL70465", -1],
    "XAD_12": ["sequence", None, "DR_SIMPLE", "ADDRESS_VALIDITY_RANGE", None, -1],
    "XAD_13": ["sequence", None, "TS", "EFFECTIVE_DATE", None, -1],
    "XAD_14": ["sequence", None, "TS", "EXPIRATION_DATE", None, -1],
    "XCN_1": ["leaf", None, "ST", "ID_NUMBER", None, -1],
    ...
    "XCN_7": ["leaf", None, "IS", "DEGREE_E_G_MD", "HL70360", -1],
    "XCN_8": ["leaf", None, "IS", "SOURCE_TABLE", "HL70297", -1],
    "XCN_9": ["sequence", None, "HD", "ASSIGNING_AUTHORITY", "HL70363", -1],
    "XCN_10": ["leaf", None, "ID", "NAME_TYPE_CODE", "HL70200", -1],
    "XCN_11": ["leaf", None, "ST", "IDENTIFIER_CHECK_DIGIT", None, -1],
    "XCN_12": ["leaf", None, "ID", "CHECK_DIGIT_SCHEME", "HL70061", -1],
    "XCN_13": ["leaf", None, "ID", "IDENTIFIER_TYPE_CODE", "HL70203", -1],
    "XCN_14": ["sequence", None, "HD", "ASSIGNING_FACILITY", None, -1],
    "XCN_15": ["leaf", None, "ID", "NAME_REPRESENTATION_CODE", "HL70465", -1],
    "XCN_16": ["sequence", None, "CE", "NAME_CONTEXT", "HL70448", -1],
    "XCN_17": ["sequence", None, "DR_SIMPLE", "NAME_VALIDITY_RANGE", None, -1],
    "XCN_18": ["leaf", None, "ID", "NAME_ASSEMBLY_ORDER", "HL70444", -1],
    "XCN_19": ["sequence", None, "TS", "EFFECTIVE_DATE", None, -1],
    "XCN_20": ["sequence", None, "TS", "EXPIRATION_DATE", None, -1],
    ...
    "XON_2": ["leaf", None, "IS", "ORGANIZATION_NAME_TYPE_CODE", "HL70204", -1],
    "XON_3": ["leaf", None, "NM", "ID_NUMBER", None, -1],
    "XON_4": ["leaf", None, "NM", "CHECK_DIGIT", None, -1],
    "XON_5": ["leaf", None, "ID", "CHECK_DIGIT_SCHEME", "HL70061", -1],
    "XON_6": ["sequence", None, "HD", "ASSIGNING_AUTHORITY", "HL70363", -1],
    "XON_7": ["leaf", None, "ID", "IDENTIFIER_TYPE_CODE", "HL70203", -1],
    "XON_8": ["sequence", None, "HD", "ASSIGNING_FACILITY", None, -1],
    "XON_9": ["leaf", None, "ID", "NAME_REPRESENTATION_CODE", "HL70465", -1],
    ...
    "XPN_6": ["leaf", None, "IS", "DEGREE_E_G_MD", "HL70360", -1],
    "XPN_7": ["leaf", None, "ID", "NAME_TYPE_CODE", "HL70200", -1],
    "XPN_8": ["leaf", None, "ID", "NAME_REPRESENTATION_CODE", "HL70465", -1],
    "XPN_9": ["sequence", None, "CE", "NAME_CONTEXT", "HL70448", -1],
    "XPN_10": ["sequence", None, "DR_SIMPLE", "NAME_VALIDITY_RANGE", None, -1],
    "XPN_11": ["leaf", None, "ID", "NAME_ASSEMBLY_ORDER", "HL70444", -1],
    "XPN_12": ["sequence", None, "TS", "EFFECTIVE_DATE", None, -1],
    "XPN_13": ["sequence", None, "TS", "EXPIRATION_DATE", None, -1],
    "XPN_14": ["leaf", None, "ST", "PROFESSIONAL_SUFFIX", None, -1],
    "XTN_1": ["leaf", None, "ST", "TELEPHONE_NUMBER", None, -1],
    "XTN_2": ["leaf", None, "ID", "TELECOMMUNICATION_USE_CODE", "HL70201", -1],
    "XTN_3": ["leaf", None, "ID", "TELECOMMUNICATION_EQUIPMENT_TYPE", "HL70202", -1],
    "XTN_4": ["leaf", None, "ST", "EMAIL_ADDRESS", None, -1],
    "XTN_5": ["leaf", None, "NM", "COUNTRY_CODE", None, -1],
    "XTN_6": ["leaf", None, "NM", "AREA_CITY_CODE", None, -1],
    "XTN_7": ["leaf", None, "NM", "LOCAL_NUMBER", None, -1],
...
DATATYPES_STRUCTS = {
    ...
    "ERL": (
        ("ERL_1", DATATYPES["ERL_1"], (0, 1), "CMP"),
        ("ERL_2", DATATYPES["ERL_2"], (0, 1), "CMP"),
