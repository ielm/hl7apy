...
GROUPS = {
    ...
    "PGL_PC6_OBR_SUPPGRP": ("choice", (["OBR", SEGMENTS["OBR"], (1, 1), "SEG"],)),
    "PGL_PC6_OBSERVATION": (
        "sequence",
        (
            ["OBX", SEGMENTS["OBX"], (1, 1), "SEG"],
    ...
    "PPG_PCG_OBR_SUPPGRP": ("choice", (["OBR", SEGMENTS["OBR"], (1, 1), "SEG"],)),
    "PPG_PCG_ORDER": (
        "sequence",
        (
            ["ORC", SEGMENTS["ORC"], (1, 1), "SEG"],
    ...
    "PPP_PCB_OBR_SUPPGRP": ("choice", (["OBR", SEGMENTS["OBR"], (1, 1), "SEG"],)),
    "PPP_PCB_ORDER": (
        "sequence",
        (
            ["ORC", SEGMENTS["ORC"], (1, 1), "SEG"],
    ...
    "PPR_PC1_OBR_SUPPGRP": ("choice", (["OBR", SEGMENTS["OBR"], (1, 1), "SEG"],)),
    "PPR_PC1_ORDER": (
        "sequence",
        (
            ["ORC", SEGMENTS["ORC"], (1, 1), "SEG"],
    ...
    "PPT_PCL_OBR_SUPPGRP": ("choice", (["OBR", SEGMENTS["OBR"], (1, 1), "SEG"],)),
    "PPT_PCL_ORDER": (
        "sequence",
        (
            ["ORC", SEGMENTS["ORC"], (1, 1), "SEG"],
    ...
    "PTR_PCF_OBR_SUPPGRP": ("choice", (["OBR", SEGMENTS["OBR"], (1, 1), "SEG"],)),
    "PTR_PCF_ORDER": (
        "sequence",
        (
            ["ORC", SEGMENTS["ORC"], (1, 1), "SEG"],
