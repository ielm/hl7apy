...
FIELDS = {
    ...
    "AL1_1": ("sequence", DATATYPES_STRUCTS["CE"], "CE", "SET_ID_AL1", None, -1),
    "AL1_2": (
        "sequence",
        DATATYPES_STRUCTS["CE"],
        "CE",
    ...
    "ECD_5": ("leaf", None, "ST", "PARAMETERS", None, -1),
    "ECR_1": (
        "sequence",
        DATATYPES_STRUCTS["CE"],
        "CE",
    ...
    "ECR_3": ("leaf", None, "ST", "COMMAND_RESPONSE_PARAMETERS", None, -1),
    ...
    "GP2_14": ("leaf", None, "NM", "PAY_RATE_PER_UNIT", None, -1),
    ...
    "MSH_21": ("leaf", None, "ID", "CONFORMANCE_STATEMENT_ID", "HL70449", -1),
    ...
    "OM4_7": ("sequence", DATATYPES_STRUCTS["CE"], "CE", "ADDITIVE", "HL70371", -1),
    ...
    "PRA_9": ("sequence", DATATYPES_STRUCTS["CE"], "CE", "INSTITUTION", None, -1),
    ...
    "SAC_22": ("leaf", None, "NM", "AVAILABLE_VOLUME", None, -1),
    ...
    "SAC_27": ("sequence", DATATYPES_STRUCTS["CE"], "CE", "ADDITIVE", "HL70371", -1),
    "SAC_28": (
        "sequence",
        DATATYPES_STRUCTS["CE"],
        "CE",
