...
GROUPS = {
    ...
    "MFR_M01_MF_QUERY": ("sequence", (["MFE", SEGMENTS["MFE"], (1, 1), "SEG"],)),
    "NMD_N02_APP_STATS": (
        "sequence",
        (
    ...
    "OML_O21_OBSERVATION_REQUEST": (
        ...
        (
            ["OBR", SEGMENTS["OBR"], (1, 1), "SEG"],
            ["OML_O21_CONTAINER_2", None, (0, -1), "GRP"],
            ["TCD", SEGMENTS["TCD"], (0, 1), "SEG"],
            ["NTE", SEGMENTS["NTE"], (0, -1), "SEG"],
            ["DG1", SEGMENTS["DG1"], (0, -1), "SEG"],
    ...
    "OML_O21_ORDER_GENERAL": (
        "sequence",
        (
            ["OML_O21_CONTAINER_1", None, (0, 1), "GRP"],
            ["OML_O21_ORDER", None, (1, -1), "GRP"],
        ),
    ),
    "OML_O21_ORDER_PRIOR": (
        "sequence",
    ...
    "ORL_O22_GENERAL_ORDER": (
        "sequence",
        (
            ["ORL_O22_CONTAINER", None, (0, 1), "GRP"],
    ...
    "ORL_O22_PATIENT": (
        ...
        (
            ["PID", SEGMENTS["PID"], (1, 1), "SEG"],
            ["ORL_O22_GENERAL_ORDER", None, (1, -1), "GRP"],
        ),
    ),
    ...
    "ORR_O02_ORDER": (
        ...
        (
            ["ORC", SEGMENTS["ORC"], (1, 1), "SEG"],
            ["ORR_O02_ORDER_DETAIL", None, (1, 1), "GRP"],
            ["NTE", SEGMENTS["NTE"], (0, -1), "SEG"],
            ["CTI", SEGMENTS["CTI"], (0, -1), "SEG"],
        ),
    ),
    ...
    "PGL_PC6_ORDER_DETAIL": (
        "sequence",
        (
            ["PGL_PC6_OBRRXO_SUPPGRP", None, (1, 1), "GRP"],
            ["NTE", SEGMENTS["NTE"], (0, -1), "SEG"],
            ["VAR", SEGMENTS["VAR"], (0, -1), "SEG"],
    ...
    "PPG_PCG_ORDER_DETAIL": (
        "sequence",
        (
            ["PPG_PCG_OBRRXO_SUPPGRP", None, (1, 1), "GRP"],
            ["NTE", SEGMENTS["NTE"], (0, -1), "SEG"],
            ["VAR", SEGMENTS["VAR"], (0, -1), "SEG"],
    ...
    "RSP_Z82_QUERY_RESPONSE": ("sequence", (["RSP_Z82_PATIENT", None, (0, 1), "GRP"],)),
    "RSP_Z82_TREATMENT": (
        "sequence",
        (
            ["RXC", SEGMENTS["RXC"], (1, -1), "SEG"],
    ...
    "RSP_Z82_VISIT": (
        ...
        (
            ...
            ["RSP_Z82_PATIENT_VISIT", None, (0, 1), "GRP"],
        ),
    ),
    ...
    "RSP_Z86_QUERY_RESPONSE": ("sequence", (["RSP_Z86_PATIENT", None, (0, 1), "GRP"],)),
    "RSP_Z88_ALLERGY": (
        "sequence",
        (
            ["AL1", SEGMENTS["AL1"], (1, -1), "SEG"],
    ...
    "RSP_Z88_QUERY_RESPONSE": ("sequence", (["RSP_Z88_PATIENT", None, (0, 1), "GRP"],)),
    "RSP_Z88_VISIT": (
        "sequence",
        (
            ["PV1", SEGMENTS["PV1"], (1, 1), "SEG"],
